...
const BoxContentWithdrawn = ({token}) => {
	...
	console.log(filteredLettersWithdrawn);
	...
	return (
		<>
			<SelectedLetterProvider>
					...
					<div className="panel-body">
						<div className="table-responsive">
							...
							<div className="flex space-x-3 form-inline">
								...
								<button name="btnSearch" type="submit" className="btn btn-default" onClick={(e) => { e.preventDefault(); filterLettersWithdrawn(); }}>
									Search
								</button>

								<button name="btnClear" type="submit" className="btn btn-default" onClick={(e) => { e.preventDefault(); clearFiltersWithdrawn(); }}>
									Clear
								</button>
							</div>
						</div>
				...
				<div className="row">
					<TableResults type={type} letterForms={filteredLettersWithdrawn} isFetching={isFetchingWithdrawn && !isLoadingSearching} />
				</div>
			</SelectedLetterProvider>
		</>
	);
...
export default BoxContentWithdrawn;