...
const BoxContentIncoming = ({token}) => {
	const type = 'incoming';
	const {
		isFetchingIncoming,
	...
	return (
		<>
			<SelectedLetterProvider>
					...
					<div className="panel-body">
						<div className="table-responsive">
							...
							<div className="flex space-x-3 form-inline">
								...
								<button name="btnSearch" type="submit" className="btn btn-default" onClick={(e) => { e.preventDefault(); filterLettersIncoming(); }}>
									Search
								</button>

								<button name="btnClear" type="submit" className="btn btn-default" onClick={(e) => { e.preventDefault(); clearFiltersIncoming(); }}>
									Clear
								</button>
							</div>
						</div>
				...
				<div className="row">
					<TableResults type={type} letterForms={filteredLettersIncoming} isFetching={isFetchingIncoming && !isLoadingSearching} />
				</div>
			</SelectedLetterProvider>
		</>
	);
...
export default BoxContentIncoming;