	...
	return (
		<>
			<SelectedLetterProvider>
					...
					<div className="panel-body">
						<div className="table-responsive">
							...
							<div className="flex space-x-3 form-inline">
								...
								<button name="btnSearch" type="submit" className="btn btn-default" onClick={(e) => { e.preventDefault(); filterLettersTagged(); }}>
									Search
								</button>

								<button name="btnClear" type="submit" className="btn btn-default" onClick={(e) => { e.preventDefault(); clearFiltersTagged(); }}>
									Clear
								</button>
							</div>
						</div>
				...
				<div className="row">
					<TableResults type={type} letterForms={filteredLettersTagged} isFetching={isFetchingTagged && !isLoadingSearching} />
				</div>
			</SelectedLetterProvider>
		</>
	);
...
export default BoxContentTagged;